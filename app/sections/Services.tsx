    ...
    <section className="bg-white" role="region" aria-labelledby="usluge-heading">
      ...
      <div className="mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 max-md:gap-0">
          ...
          <ServicesCard link={'/oftalmologija'} bgImage={'/images/operacija_mrene2.jpeg'} heading={"Oftalmologija"} text={"Vrhunska oftalmološka skrb – detaljnih pregleda i precizne dijagnostike do suvremenih zahvata. Brinemo o zdravlju Vaših očiju stručno, sigurno i s povjerenjem."}></ServicesCard>
